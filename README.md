...
I decided suddenly almost after 10 days that I need to get my shit together, and the first thing I came up is to create a project on my own, so I looked up and though of starting with basic console application of password generation and checking the strength.

Basic outline of design or requirement whatever you call is as below.
...
## Tip - In this world full of chaos be a better ctrl+v and ctrl+c person. :)